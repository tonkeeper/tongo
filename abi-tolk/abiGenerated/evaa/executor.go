...
type Master interface {
	...
	GetUserSubaccountAddress(ctx context.Context, reqAccountID ton.AccountID, ownerAddress tlb.InternalAddress, subaccountId tlb.Int257) (tlb.InternalAddress, error)
...
type MasterWithAccount interface {
	...
	GetUserSubaccountAddress(ctx context.Context, ownerAddress tlb.InternalAddress, subaccountId tlb.Int257) (tlb.InternalAddress, error)
...
type User interface {
	...
	GetPrincipals(ctx context.Context, reqAccountID ton.AccountID) (boc.Cell, error)
...
type UserWithAccount interface {
	...
	GetPrincipals(ctx context.Context) (boc.Cell, error)
