...
type BidPaymentData struct {
	...
	BidJettonWallet tlb.MsgAddress                      // any_address
...
type UserPaymentData struct {
	User                           tlb.MsgAddress                      // any_address
	UserReceiveJettonWallet        tlb.MsgAddress                      // any_address
