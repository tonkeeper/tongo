...
var contractErrors = map[ContractInterface]map[int32]string{
	BidaskLpMultitoken: {
		83: "Insufficient gas for operation",
	},
	BidaskPool: {
		83: "Insufficient gas for operation",
	},
	CoffeeCrossDex: {
		100: "Invalid payload to resend",
		101: "Dedust payload is empty",
		102: "ProxyTON payload is empty",
		103: "BidAsk payload is empty",
		200: "Not an admin",
	},
	CoffeeFactory: {
		250: "Unexpected",
	...
	CoffeeVaultJetton: {
		260: "Invalid jetton master",
		272: "Already active",
		273: "Not active",
	},
	MultisigOrderV2: {
		104:   "Unauthorized init",
		105:   "Already inited",
	...
	NftSaleGetgemsV2: {
		404:   "Already sold or cancelled",
		450:   "Not enough Gram for sale",
		457:   "Not enough Gram for cancellation",
