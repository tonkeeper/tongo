...
var KnownGetMethodsDecoder = map[string][]func(tlb.VmStack) (string, any, error){
	...
	"get_domain_auction_info":       {DecodeGetDomainAuctionInfoResult},
	"get_domain_data":               {DecodeGetDomainDataResult},
	"get_domain_editor":             {DecodeGetDomainEditorResult},
...
var ResultTypes = []interface{}{
	...
	&GetDomainAuctionInfoResult{},
	&GetDomainDataResult{},
	&GetDomainEditorResult{},
	&GetDomainResult{},
	&GetEditorResult{},
	&GetFullDomainResult{},
	&GetJettonDataResult{},
...
type GetDomainAuctionInfoResult struct {
	MaxBidAddress  []byte
	MaxBidAmount   tlb.Int256
	AuctionEndTime int64
}

func GetDomainAuctionInfo(ctx context.Context, executor Executor, reqAccountID tongo.AccountID) (string, any, error) {
	stack := tlb.VmStack{}

	// MethodID = 67859 for "get_domain_auction_info" method
	errCode, stack, err := executor.RunSmcMethodByID(ctx, reqAccountID, 67859, stack)
	if err != nil {
		return "", nil, err
	}
	if errCode != 0 && errCode != 1 {
	...
	for _, f := range []func(tlb.VmStack) (string, any, error){DecodeGetDomainAuctionInfoResult} {
		s, r, err := f(stack)
		if err == nil {
			return s, r, nil
		}
...
func DecodeGetDomainAuctionInfoResult(stack tlb.VmStack) (resultType string, resultAny any, err error) {
	if len(stack) != 3 || (stack[0].SumType != "VmStkSlice") || (stack[1].SumType != "VmStkTinyInt" && stack[1].SumType != "VmStkInt") || (stack[2].SumType != "VmStkTinyInt" && stack[2].SumType != "VmStkInt") {
		return "", nil, fmt.Errorf("invalid stack format")
	}
	var result GetDomainAuctionInfoResult
	err = stack.Unmarshal(&result)
	return "GetDomainAuctionInfoResult", result, err
}

type GetDomainDataResult struct {
	Init              tlb.Int256
	Index             tlb.Int256
	CollectionAddress []byte
	OwnerAddress      []byte
	Content           []byte
}

func GetDomainData(ctx context.Context, executor Executor, reqAccountID tongo.AccountID) (string, any, error) {
	stack := tlb.VmStack{}

	// MethodID = 72859 for "get_domain_data" method
	errCode, stack, err := executor.RunSmcMethodByID(ctx, reqAccountID, 72859, stack)
	if err != nil {
		return "", nil, err
	}
	if errCode != 0 && errCode != 1 {
	...
	for _, f := range []func(tlb.VmStack) (string, any, error){DecodeGetDomainDataResult} {
		s, r, err := f(stack)
		if err == nil {
			return s, r, nil
		}
...
func DecodeGetDomainDataResult(stack tlb.VmStack) (resultType string, resultAny any, err error) {
	...
	var result GetDomainDataResult
	err = stack.Unmarshal(&result)
	return "GetDomainDataResult", result, err
}

type GetDomainEditorResult struct {
	OwnerAddress []byte
}

func GetDomainEditor(ctx context.Context, executor Executor, reqAccountID tongo.AccountID) (string, any, error) {
	stack := tlb.VmStack{}

	// MethodID = 122184 for "get_domain_editor" method
	errCode, stack, err := executor.RunSmcMethodByID(ctx, reqAccountID, 122184, stack)
	if err != nil {
		return "", nil, err
	}
	if errCode != 0 && errCode != 1 {
	...
	for _, f := range []func(tlb.VmStack) (string, any, error){DecodeGetDomainEditorResult} {
		s, r, err := f(stack)
		if err == nil {
			return s, r, nil
		}
...
func DecodeGetDomainEditorResult(stack tlb.VmStack) (resultType string, resultAny any, err error) {
	if len(stack) < 1 || (stack[0].SumType != "VmStkSlice") {
		return "", nil, fmt.Errorf("invalid stack format")
	}
	var result GetDomainEditorResult
	err = stack.Unmarshal(&result)
	return "GetDomainEditorResult", result, err
}
