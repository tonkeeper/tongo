...
func (w *walletV4) CreateMsgBodyWithoutSignature(internalMessages []RawMessage, msgConfig MessageConfig) (*boc.Cell, error) {
	body := MessageV4{
		SubWalletId: w.subWalletID,
...
func (w *walletV4) AttachSignature(body *boc.Cell, signature tlb.Bits512) (*boc.Cell, error) {
...
func (w *walletV4) GetPublicKey() ed25519.PublicKey {
	return w.publicKey
}
